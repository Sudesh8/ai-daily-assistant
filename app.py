...
def home_page():
    ...
    st.image(
        get_random_image(),
        caption="A beautiful morning to start your day",
...
def interest_news_page():
    ...
    interest = st.text_input(
        "Enter your area of interest (e.g., Technology, Sports, Health):", "Technology"
    )
...
page_option = st.sidebar.radio(
    "Choose a page:",
    ("Home", "Get Weather of your City", "News by Interest", "Smart Planner"),
)
st.sidebar.markdown("---")
